...
class Title:
    def __init__(self):
        ...
        #delay for the change of selected option, otherwise the selection gets really crazy
        self.timer=0
        self.delay=5
        
        self.selected = 0
        
        # what should be called for each option
        self.actions=["game","highscore","exit"]
